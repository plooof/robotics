...
public class Robot extends TimedRobot {
  ...
  private final VictorSPX frontLeft = new VictorSPX(0);
  private final VictorSPX frontRight = new VictorSPX(1);
  private final VictorSPX backLeft = new VictorSPX(2);
  private final VictorSPX backRight = new VictorSPX(3);
